...
`ferramentas/fechar_m9_windows.ps1`. **Roteiro paridade &lt; 0,3%:**
[`docs/paridade-visual-harmonia.md`](../../docs/paridade-visual-harmonia.md).
Atualize F1-13 Bloco I (I1–I3), roadmap M9, gap R24 no `AGENT_BRIEF`, push `main`.
