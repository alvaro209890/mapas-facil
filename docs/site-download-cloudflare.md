...
| Instalador `.exe` (GitHub Releases) | https://github.com/alvaro209890/mapas-facil/releases/download/v0.5.2/MapasFacil-Setup-0.5.2.exe |
| Manifesto JSON | https://github.com/alvaro209890/mapas-facil/releases/latest/download/download-manifest.json |
| Release | `v0.5.2` — tag no repositório `alvaro209890/mapas-facil` |
...
Esperado: serviços `active`, HTTP 200, link `MapasFacil-Setup-0.5.2.exe`.
